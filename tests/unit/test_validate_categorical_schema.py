...
def test_validate_categorical_schema_all_valid_pass():
    """Test that validation passes when all categorical values are valid."""
...
def test_validate_categorical_schema_single_invalid_match():
    """Test that a single invalid categorical value is correctly recorded."""
...
def test_validate_categorical_schema_na_ignored_only_non_na_checked():
    """Test that missing values are ignored during categorical validation."""
...
def test_empty_allowed_categories():
    """Test that empty allowed categories raise a ValueError."""
...
def test_validate_categorical_schema_invalid_column_arg(bad_column):
    """Test that invalid column arguments raise a ValueError."""
...
def test_validate_categorical_schema_none_allowed_categories():
    """Test that None as allowed categories raises a ValueError."""
    df = pd.DataFrame({"color": ["red"]})
    with pytest.raises(ValueError):
...
def test_validate_categorical_schema_iterable_allowed_categories():
    """Test that allowed categories can be provided as different iterable types."""
